...
public class OrderTestService {
    ...
    //== Kafka로 주문/결제 취소 ==//
    @Transactional
    @KafkaListener(topics = "order-rollback-topic", groupId = "member-order-rollback-group",/*member group으로 부터 메시지가 들어오면*/ containerFactory = "kafkaListenerContainerFactory")
