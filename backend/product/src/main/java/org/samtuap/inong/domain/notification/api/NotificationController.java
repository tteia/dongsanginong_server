...
public class NotificationController {
    ...
    @GetMapping
    public ResponseEntity<Page<NotificationGetResponse>> getNotification(Pageable pageable, @RequestParam(value = "unread", required = false) boolean unread, @RequestHeader("sellerId") Long sellerId) {
